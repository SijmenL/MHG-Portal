                ...
                <div class="collapse navbar-collapse navbar-info" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto d-flex align-items-center">
                        ...
                        <ul class="navbar-nav align-items-start justify-content-start justify-content-md-start" id="navbar">
                            ...
                            <li class="nav-item">
                                <a class="nav-link d-flex flex-row gap-1 justify-content-center align-items-center white-text"
                                   href="{{ route('loodsen.flunkyball') }}"><img alt="loodsen" class="navbar-icon" src="{{ asset('files/loodsen/flunkyball/logo/logo-flunkyball.webp') }}">Flunkyball</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link d-flex flex-row gap-1 justify-content-center align-items-center white-text"
                                   href="{{ route('loodsen') }}"><img alt="loodsen" class="navbar-icon" src="{{ asset('files/loodsen/logo-bar.webp') }}">Loodsenbar</a>
                            </li>
                        </ul>
                        @guest
                            @if (Route::has('login'))
