                        ...
                        <ul class="navbar-nav align-items-start justify-content-start justify-content-md-start" id="navbar">
                            <li class="nav-item">
                                <a class="nav-link d-flex flex-row gap-1 justify-content-center align-items-center white-text"
                                   href="{{ route('technisch_team') }}"><span class="material-symbols-rounded">construction</span>Home</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link d-flex flex-row gap-1 justify-content-center align-items-center white-text"
                                   href="{{ route('technisch_team.files') }}"><span
                                        class="material-symbols-rounded">folder_open</span>Bestanden</a>
                            </li>
