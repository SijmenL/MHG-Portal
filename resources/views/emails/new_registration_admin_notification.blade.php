...
@section('title')
    <h1 class="email-title">Er is een inschrijving goedgekeurd!</h1>
@endsection
...
@section('info')
    <div>
        ...
        <p>Beste {{ $data['reciever_name'] }}, {{ $user->name.' '.$user->infix.' '.$user->last_name }} heeft zich
            ingeschreven als {{ $user->roles[0]->role }}, en is door de hoofdleiding geaccepteerd.</p>
        <br>
        ...
        <br>
        <p>{{ $user->name }} heeft nu toegang tot het ledenportaal.</p>
        <br>
...
@section('main_footer')
    <td style="padding-top: 30px;">
        ...
        <p class="footer-text">
            Deze email is automatisch gegenereerd omdat iemand die zich heeft ingeschreven is geaccepteerd door de hoofleiding.
