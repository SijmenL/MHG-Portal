...
@section('info')
    ...
    <div>
        <p>Beste {{ $data['reciever_name'] }}, je inschrijving is geaccepteerd. Welkom bij de groep!</p>
        <br>
...
@section('main_footer')
    <td style="padding-top: 30px;">
        ...
        <p class="footer-text">
            Deze email is automatisch gegenereerd omdat je inschrijving voor de MHG is goedgekeurd.
        </p>
    </td>
@endsection
