    ...
    <div class="container col-md-11">
        ...
        <div class="mt-1 bg-white p-2 rounded d-flex flex-row justify-content-between">
            <div class="d-flex flex-row">
                <form method="POST" action="{{ route('lessons.environment.lesson.post.store', [$lesson->id, $post->id]) }}">
                    @csrf
                ...
                <a href="{{ route('lessons.environment.lesson.post', [$lesson->id, $post->id]) }}" class="btn d-flex align-items-center"><span
