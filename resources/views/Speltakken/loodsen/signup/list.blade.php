...
@section('content')
    ...
    <div class="container col-md-11">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item" aria-current="page"><a href="{{route('loodsen')}}">loodsen</a></li>
                <li class="breadcrumb-item" aria-current="page"><a href="{{route('loodsen.inbox')}}">Inbox</a></li>
                            ...
                            <th>
                                <div class="dropdown position-relative">
                                    ...
                                    <ul class="dropdown-menu"
                                        ...
                                        <li>
                                            <a href="{{ route('loodsen.signup.details', ['id' => $all_user->id]) }}"
                                               class="dropdown-item">Details</a>
                                        </li>
                                        <li>
                                            <a href="{{ route('loodsen.signup.accept', ['id' => $all_user->id]) }}"
                                        ...
                                        <li>
                                            <a class="delete-button dropdown-item cursor-pointer text-danger"
                                               ...
                                               data-link="{{ route('loodsen.signup.delete', $all_user->id) }}">Verwijderen</a>
                                        </li>
                                    </ul>
                                </div>
                            </th>
