        ...
        <div class="py-4 container col-md-11">
            ...
            <div class="d-flex flex-row-responsive justify-content-center align-items-center gap-5">
                <div class="w-100">
                    ...
                    <form action="{{ route('loodsenbar.edit.product', ['id' => $product->id]) }}" method="POST">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="description" name="description" rows="3">{{ $product->name }}</textarea>
                        </div>
                        <div class="form-group">
                            <label for="price">Price</label>
                            <input type="number" class="form-control" id="price" name="price" min="0" value="{{ $product->price }}" step="any" required>
                        </div>
                        <div class="form-group">
