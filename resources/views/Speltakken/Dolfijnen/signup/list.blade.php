...
@section('content')
    ...
    <div class="container col-md-11">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item" aria-current="page"><a href="{{route('dolfijnen')}}">Dolfijnen</a></li>
                <li class="breadcrumb-item" aria-current="page"><a href="{{route('dolfijnen.inbox')}}">Inbox</a></li>
                            ...
                            <th>
                                <div class="dropdown position-relative">
                                    ...
                                    <ul class="dropdown-menu"
                                        ...
                                        <li>
                                            <a href="{{ route('dolfijnen.signup.details', ['id' => $all_user->id]) }}"
                                               class="dropdown-item">Details</a>
                                        </li>
                                        <li>
                                            <a href="{{ route('dolfijnen.signup.accept', ['id' => $all_user->id]) }}"
                                        ...
                                        <li>
                                            <a class="delete-button dropdown-item cursor-pointer text-danger"
                                               ...
                                               data-link="{{ route('dolfijnen.signup.delete', $all_user->id) }}">Verwijderen</a>
                                        </li>
                                    </ul>
                                </div>
                            </th>
