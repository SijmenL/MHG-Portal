...
@section('content')
    <div id="popUp" class="popup d-none" style="margin-top: -122px">
        <div class="popup-body">
            ...
            <p>Alle @if($selected_role === 'Zeeverkenners') zeeverkenners @else ouders @endif die aan je zoekopdracht voldoen worden geëxporteerd.</p>
            <div class="bg-light rounded-2 p-3">
                <h2>Opties</h2>
                <div class="quick-action-bar">
                    <form class="m-0 p-0 quick-action" action="{{ route('zeeverkenners.groep.export') }}" method="POST">
                        @csrf
    ...
    <div class="container col-md-11">
        ...
        @else
            <div class="alert alert-warning d-flex align-items-center" role="alert">
                <span class="material-symbols-rounded me-2">person_off</span>Geen @if($selected_role === 'Zeeverkenners')zeeverkenners @else ouders @endif gevonden...
            </div>
        @endif
    </div>
@endsection
