...
@section('content')
    ...
    <div class="container col-md-11">
        ...
        <form id="auto-submit" method="POST" action="{{ route('afterloodsen.group.search') }}">
            @csrf
            <div class="d-flex">
            ...
            <div class="overflow-scroll no-scrolbar" style="max-width: 100vw">
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        @if(auth()->user() && (auth()->user()->roles->contains('role', 'Afterloodsen Organisator') || auth()->user()->roles->contains('role', 'Administratie') || auth()->user()->roles->contains('role', 'Bestuur')))
                        ...
                        <tr id="{{ $all_user->id }}">
                            ...
                            <th>
                                ...
                                <div class="d-flex flex-row flex-wrap gap-2">
                                    <a href="{{ route('afterloodsen.groep.details', ['id' => $all_user->id]) }}"
        ...
        @else
            <div class="alert alert-warning d-flex align-items-center" role="alert">
                <span class="material-symbols-rounded me-2">person_off</span>Geen afterloodsen gevonden...
            </div>
        @endif
    </div>
@endsection
