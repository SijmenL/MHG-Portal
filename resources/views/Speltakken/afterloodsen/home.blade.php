...
@section('content')
    <div class="header" style="background-image: linear-gradient(rgba(0, 0, 0, 0), rgba(0, 0, 0, 0.5)), url({{ asset('files/afterloodsen/overzwaaien.webp') }})">
        <div>
    ...
    <div class="container col-md-11">
        ...
        <div class="d-flex flex-row-responsive justify-content-center align-items-center gap-5">
            <div class="">
                <h1 class="">Opties</h1>
                <p>Welkom op het Afterloodsen portaal! Hier kun je verschillende posts vinden en maken! Meld je aan of af voor het groepdraaien via <a href="{{ route('agenda.month') }}">de agenda</a>!</p>
                ...
                <div class="bg-light rounded-2 p-3">
                    ...
                    <div class="quick-action-bar">
                        ...
                        @if(auth()->user() && (auth()->user()->roles->contains('role', 'Afterloodsen Organisator') || auth()->user()->roles->contains('role', 'Administratie') || auth()->user()->roles->contains('role', 'Bestuur')|| auth()->user()->roles->contains('role', 'Ouderraad')))
                            ...
                            <a class="btn btn-admin quick-action" href="{{ route('afterloodsen.inbox') }}">
                        ...
                        @endif
                            ...
                            <a class="btn btn-info quick-action" href="{{ route('afterloodsen.files') }}">
            ...
            <div class="">
                <img class="w-100 zoomable-image" alt="groepsfoto" src="{{ asset('files/afterloodsen/afterloodsen.jpg') }}">
            </div>
        </div>
                    ...
                    <div class="container">
                        ...
                        <form method="POST" action="{{ route('afterloodsen.message-post') }}">
                            ...
                            handleButtonClick(this)"
                                class="btn btn-dark mt-4 flex flex-row align-items-center justify-content-center">
