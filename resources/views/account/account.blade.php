    ...
    <div class="container col-md-11">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page"><a href="{{route('admin')}}">Mijn Account</a></li>
            </ol>
        </nav>
        ...
        <form method="POST" action="{{ route('admin.account-management.store', $user) }}"
            ...
            <div class="overflow-scroll no-scrolbar" style="max-width: 100vw">
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <th><input id="email" value="{{ $user->email }}" type="email" class="form-control @error('email') is-invalid @enderror" name="email"  autocomplete="email">
                            @error('email')
                            <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                    ...
                    <tr>
                        <th><label for="password" class="col-md-4 col-form-label text-md-end">Nieuw wachtwoord</label></th>
                    ...
                    <tr>
                        ...
                        <th>
                            ...
                            @endif
                            <input class="form-control mt-2" value="{{ $user->profile_picture }}" id="profile_picture"
                    ...
                    <tr>
                        ...
                        <th><input id="birth_date" value="{{ $user->birth_date }}" type="date" class="form-control @error('birth_date') is-invalid @enderror" name="birth_date" >
                            @error('birth_date')
                            <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                    ...
                    <tr>
                        ...
                        <th><input id="street" value="{{ $user->street }}" type="text" class="form-control @error('street') is-invalid @enderror" name="street" >
                            @error('street')
                            <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                    ...
                    <tr>
                        ...
                        <th><input id="postal_code" value="{{ $user->postal_code }}" type="text" class="form-control @error('postal_code') is-invalid @enderror" name="postal_code" >
                            @error('postal_code')
                            <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                    ...
                    <tr>
                        ...
                        <th><input id="city" value="{{ $user->city }}" type="text" class="form-control @error('city') is-invalid @enderror" name="city" >
                            @error('city')
                            <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                    ...
                    <tr>
                        ...
                        <th><input id="phone" value="{{ $user->phone }}" type="text" class="form-control @error('phone') is-invalid @enderror" name="phone" >
                            @error('phone')
                            <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                    ...
                    <tr>
                        ...
                        <th><input id="member_date" value="{{ $user->member_date }}" type="date" class="form-control @error('member_date') is-invalid @enderror" name="member_date">
                            @error('member_date')
                            <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
            ...
            <div class="d-flex flex-row flex-wrap gap-2">
                ...
                <a href="{{ route('admin.account-management.details', ['id' => $user->id]) }}"
